...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "c", function () awful.spawn(RC.vars.colorpicker) end,
              {description = "color picker", group = "launcher"}),
    awful.key({ modkey,           }, "f", function () awful.spawn(RC.vars.firefox) end,
              {description = "color firefox", group = "launcher"}),
    awful.key({ modkey,           }, "b", function () awful.spawn(RC.vars.browser) end,
              {description = "color browser", group = "launcher"}),
    ...
    awful.key({ modkey },            "w",     function () toggle() end,
              {description = "run prompt", group = "launcher"}),
    ...
    awful.key({ modkey, "Shift"   }, "q", function ()  awful.spawn(RC.vars.logout) end,
