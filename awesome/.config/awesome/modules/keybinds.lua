...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, 'c', function()
        awful.spawn(RC.vars.colorpicker)
    ...
    awful.key({ modkey }, 'w', function()
        toggle()
    end, { description = 'toogle statusbar', group = 'launcher' }),
    awful.key({ modkey }, 'space', function()
        awful.spawn('rofi -show drun')
    end, { description = 'drun rofi', group = 'launcher' }),
    awful.key({ modkey, 'Control' }, 'v', function()
        awful.spawn.with_shell('expressvpn disconnect && expressvpn connect')
    end, { description = 'reload vpn', group = 'launcher' }),
